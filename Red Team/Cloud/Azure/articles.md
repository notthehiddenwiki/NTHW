...
52. Security lists for SOC/DFIR detections – Awesome Security lists for SOC/CERT/CTI – [link](https://github.com/mthcht/awesome-lists)
53. Azure Samples – [link](https://github.com/Azure-Samples)
54. Azure Sentinel – Cloud-native SIEM for intelligent security analytics – [link](https://github.com/Azure/Azure-Sentinel)
55. Azure Network Security – Resources for Azure Network Security – [link](https://github.com/Azure/Azure-Network-Security)
56. Microsoft Defender for Cloud community repo – [link](https://github.com/Azure/Microsoft-Defender-for-Cloud)
57. Microsoft Azure training for researchers – [link](https://github.com/MSRConnections/Azure-training-course)
58. Azure Cost Anomaly Alert Manager – Python CLI tool for managing cost anomaly alerts – [link](https://github.com/p4pryk/CostAnomalyCreator)
59. Azure MCP Server – Implements the MCP specification for AI agents integration – [link](https://github.com/Azure/azure-mcp)
60. Azure Vulnerability Report Generator – Detects and reports Azure security vulnerabilities – [link](https://github.com/p4pryk/AzureVulnerabilityReport)
61. Azure Security Benchmark Report (MSBReport) – Security recommendations visualization – [link](https://github.com/p4pryk/MSBReport)
62. remote-mcp-apim-functions-python – Azure API Management as AI Gateway – [link](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)
63. Data & AI Platform – Tools for deploying and configuring Azure AI estate – [link](https://github.com/microsoft/Data-and-AI-Platform)
64. Workout – Test framework for Azure Bicep – [link](https://github.com/TheCloudTheory/Workout)
65. Azure OpenAI in a Day Workshop – [link](https://github.com/microsoft/azure-openai-in-a-day-workshop)
