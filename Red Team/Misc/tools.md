...
56. List of ngrok alternatives and other ngrok-like tunneling software and services. - [link](https://github.com/anderspitman/awesome-tunneling)
57. Ready to go Phishing Platform - [link](https://github.com/JoelGMSec/EvilnoVNC)
58. Generate unicode domains for IDN Homograph Attack and detect them. - [link](https://github.com/UndeadSec/EvilURL)
59. Malicious Shortcut(.lnk) Generator - [link](https://github.com/it-gorillaz/lnk2pwn)
60. MailSniper is a penetration testing tool for searching through email in a Microsoft Exchange - [link](https://github.com/dafthack/MailSniper)
61. BadAssMacros - C# based automated Malicous Macro Generator. - [link](https://github.com/Inf0secRabbit/BadAssMacros)
62. GoPhish - [link](https://github.com/gophish/gophish)
63. HTA encryption tool for RedTeams - [link](https://github.com/nccgroup/demiguise)
64. A collection of captive portals for phishing using a WiFi Pineapple - [link](https://github.com/kleo/evilportals)
65. Spoofy is a program that checks if a list of domains can be spoofed based on SPF and DMARC records. - [link](https://github.com/MattKeeley/Spoofy)
66. A great collection of resources to thrive off the land - [link](https://lolol.farm/)
67. Static binary for Linux - [link](https://github.com/ernw/static-toolbox/releases)
68. Vulnerable test websites for Vulnerability Scanners - [link](http://vulnweb.com/)
69. A collection of bookmarks for penetration testers, bug bounty hunters, malware developers, reverse engineers - [link](https://github.com/kargisimos/offensive-bookmarks)
70. How to launch Command Prompt and powershell from MS Paint - [link](https://tzusec.com/how-to-launch-command-prompt-and-powershell-from-ms-paint/)
71. Webhook.site | Test, process and transform emails and HTTP requests (BURP Collab alternative) - [link](https://webhook.site/)
