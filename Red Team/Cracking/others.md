...
14. haiti: haiti is a A CLI tool (and library) to identify hash types (hash type identifier). - [link](https://github.com/noraj/haiti)
15. geowordlists: tool to generate wordlists of passwords containing cities at a defined distance around the client city. - [link](https://github.com/p0dalirius/GeoWordlists)
16. pdfcrack: A tool for cracking password-protected PDF files - [link](https://github.com/robins/pdfcrack)