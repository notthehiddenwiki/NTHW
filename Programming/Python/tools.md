...
8. ty - An extremely fast Python type checker and language server, written in Rust. - [link](https://github.com/astral-sh/ty)
9. ruff - An extremely fast Python linter and code formatter, written in Rust. - [link](https://github.com/astral-sh/ruff)
