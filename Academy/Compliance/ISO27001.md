...
• Governance: arrangements to direct and control the organisation’s activities.
...
• Risk: the probability that bad things might happen, coupled with the consequences if they do. Or: “The effect of uncertainty on objectives” (ISO 31000).
...
• Vulnerability: a weakness that can be exploited by a threat to gain unauthorised access to or otherwise harm a system or organisation.
• Resilience: the ability to withstand or recover quickly from difficult conditions, including incidents and disruptions.
• Incident Response: the process of handling and managing the aftermath of a security breach or cyberattack to limit damage and reduce recovery time and costs.
